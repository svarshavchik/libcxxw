...
textlist_cellimageObj::textlist_cellimageObj(const std::vector<icon> &images,
					     halign alignment)
...
textlist_cellimageObj::cell_get_metrics(IN_THREAD_ONLY, dim_t preferred_width,
					bool visible)
{
...
void textlist_cellimageObj::cell_redraw(IN_THREAD_ONLY,
...
void textlist_cellimageObj::cell_initialize(IN_THREAD_ONLY,
					    const defaulttheme &initial_theme)
{
	initialize(IN_THREAD);
}

void textlist_cellimageObj::cell_theme_updated(IN_THREAD_ONLY,
					       const defaulttheme &new_theme)
{
	theme_updated(IN_THREAD, new_theme);
}

bool textlist_cellimageObj::cell_is_empty()
{
	return false;
}
